...
public class DegisimBekleyenAdapter extends BaseAdapter implements Filterable {
    private LayoutInflater mInflater;
    private Context context;
    private List<SatisObject> mKisiListesi;
    private List<SatisObject> mYedek;
    private ItemFilter mFilter = new ItemFilter();
    private DegisimBekleyen degisimFragment;
    public DegisimBekleyenAdapter(Activity activity, List<SatisObject> satisObjects, DegisimBekleyen degisimFragment) {
        ...
        mYedek=satisObjects;
        this.degisimFragment = degisimFragment;
    }
    @Override
    public int getCount() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SatisDetayActivity.degisimBekleyen = degisimFragment;
        ...
        viewHolder.aktar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                builder.setMessage("Tüm ürünleri sepetinize aktarır ve değişimi iptal eder!").setPositiveButton("Evet", dialogClickListener)
                        .setNegativeButton("Hayır", dialogClickListener).show();
            }
        });
        ...
        protected String doInBackground(String... values)
        {
            ...
            try{
                if(values[1].equals("1"))
                    readURL.readURL("http://modayakamoz.com/json/degisim_iptal.php?ID="+values[0]+"&komisyoncu_ID="+ dbHelper.getUser().getID());
                else if (values[1].equals("2"))
                    readURL.readURL("http://modayakamoz.com/json/sepete_aktar_degisim.php?ID="+values[0]+"&komisyoncu_ID="+dbHelper.getUser().getID());
                return "0";
            }
            catch (Exception e){
                return "HATA";
